...
{   
    ...
    //that is for knight 1, n*m knight2 once 1 has been placed then (n*m - 1)
    //Hence total -> n*m(n*m - 1)
    //total viable coditions = total - positions of conflict on the board.
